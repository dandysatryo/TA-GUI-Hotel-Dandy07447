...
public class TamuCLI {
    ...
    public void inputKamar() {
        ...
        System.out.print("Masukkan Lama Checkin = ");
        ...
        switch (pilih) {
            case "1" ->
                inputLokal(nama, noHp, alamat, lama);
            case "2" ->
                inputLuar(nama, noHp, alamat, lama);
            default ->
    ...
    private KamarEntity CariKamarLokal(String nama, String noHp, String alamat, int lama, int ktp) {
        ...
        do {
            ...
            kamar = AllObjectController.tamucon.cari(noKamar);
            if (kamar != null) {
    ...
    public void checkoutLokal() {
        System.out.print("Masukan Kode Kamar    = ");
        String noKamar = input.nextLine();
        int index = AllObjectController.tamucon.cariReservasibyKodeKamarLokal(noKamar);
        if (index > -1) {
    ...
    public void checkoutLuar() {
        System.out.print("Masukan Kode Kamar    = ");
        String noKamar = input.nextLine();
        int index = AllObjectController.tamucon.cariReservasibyKodeKamarLuar(noKamar);
        if (index > -1) {
    ...
    public void displayLokal() {
        if (AllObjectModel.tamuMdl.allLokal().isEmpty()) {
            System.out.println();
            System.out.println("===========================");
